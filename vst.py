...
class SwinTransformer3D(nn.Module):
    ...
    def __init__(self,
        ...
        self.out_proj = nn.Conv2d(embed_dim//4, out_channels, kernel_size=3, padding="same")
    ...
    def forward(self, x):
        ...
        return x.reshape(x.shape[0],-1,384,144)#self.out_proj(x.reshape(x.shape[0],-1,384,144))
